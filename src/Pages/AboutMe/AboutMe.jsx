    ...
    return (
        <section className=" h-screen  text-center">
            ...
            <article className="flex justify-center items-start w-11/12 my-10">
                ...
                <div>
                    <div
                        className="text-lg md:text-2xl text-left font-bold text-slate-100 ">
                    ...
                    <div className="flex md:block text-left my-10 text-red-100 font-extrabold">
                        ...
                        <Link to='/contact' className="bg-transparent hover:bg-black ms-3 py-2 px-4 border border-gray-600 rounded-lg shadow-md hover:shadow-sm shadow-green-300">Hire Me</Link>
